...
export class CartService {
   ...
   * If the cart exists, add a new item into a cart if the cart doesn't contains it.
   * If the cart exists and contains the product, update the quantity and the subTotalPrice
   */
